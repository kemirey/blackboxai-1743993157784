...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO surat_keluar (nomor_surat, tanggal, perihal, ditujukan, isi) VALUES (?, ?, ?, ?, ?)");
    $stmt->bind_param("sssss", $nomor_surat, $tanggal, $perihal, $ditujukan, $isi);
    $stmt->execute();
...
$query = "SELECT * FROM surat_keluar WHERE nomor_surat LIKE ? OR perihal LIKE ? ORDER BY tanggal DESC";
...
<head>
    ...
    <title>Surat Keluar - Sistem Surat Masama</title>
...
<body class="bg-gray-100">
    <div class="flex h-screen">
        ...
        <div class="flex-1 p-8">
            ...
            <!-- Search Bar -->
            <div class="mb-6">
                <form action="surat_keluar.php" method="GET" class="flex">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <a href="detail_surat_keluar.php?id=<?= $row['id'] ?>" class="text-blue-600 hover:text-blue-800 mr-3">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="edit_surat_keluar.php?id=<?= $row['id'] ?>" class="text-yellow-600 hover:text-yellow-800 mr-3">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a href="delete_surat_keluar.php?id=<?= $row['id'] ?>" class="text-red-600 hover:text-red-800" onclick="return confirm('Hapus surat ini?')">
    ...
    <div id="addModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center p-4">
        <div class="bg-white rounded-lg shadow-xl w-full max-w-2xl">
            ...
            <form action="surat_keluar.php" method="POST" class="p-4">
